"""
Django settings for mkpiketrial project.
...
import os
import django_on_heroku #added for heroku
...
INSTALLED_APPS = [
    ...
    'phonenumber_field',#phonenumbers
...
WSGI_APPLICATION = 'mkpiketrial.wsgi.application'
